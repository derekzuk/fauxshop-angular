[![Build Status](https://travis-ci.org/derekzuk/fauxshop-angular.svg?branch=master)](https://travis-ci.org/derekzuk/fauxshop-angular)
...
To optimize the fauxshopangular application for production, run:
